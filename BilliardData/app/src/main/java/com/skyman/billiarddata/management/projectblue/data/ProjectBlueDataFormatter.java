...
public class ProjectBlueDataFormatter {
     ...
     */
    public static String getFormatOfScore(ArrayList<String> scores) {
     ...
     * @return score 의 length 에 맞는 형태로 만든 값
     */
    public static String getFormatOfScore(int[] scores) {
        ...
        // 1. 첫번째 스코어
        scoreData.append(scores[0]);

        // [cycle 1] : score 의 1 번째 부터 length 까지
        for (int index = 1; index < scores.length; index++) {
            scoreData.append(" : ");
            scoreData.append(scores[index]);
        }
