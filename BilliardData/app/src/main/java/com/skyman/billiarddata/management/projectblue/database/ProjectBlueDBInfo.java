...
/**
 * 이 클래스는 project_blue.db 의 정보를 저장하고 있다.
 *
 * <p>
 * TABLE_NAME : project_blue
 * TABLE_VERSION : 해당 db 를 관리하기 위한 버전
 *
 * */
public final class ProjectBlueDBInfo {

    // instance variable = instance member = instance filed

    // instance constant =  instance member = instance filed = (keyword)final
