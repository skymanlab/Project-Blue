...
public class FriendTableSetting {
    ...
    public static final String SQL_CREATE_TABLE =
            "CREATE TABLE " + Entry.TABLE_NAME + " (" +
                    ...
                    Entry.COLUMN_NAME_RECENT_GAME_BILLIARD_COUNT + " INTEGER, " +   // 5. recent game billiard count    - integer
    ...
    public static class Entry implements BaseColumns {
        ...
        public static final String COLUMN_NAME_RECENT_GAME_BILLIARD_COUNT = "recentGameBilliardCount";      // 5. recent game billiard count
