...
public class FriendDbHelper extends SQLiteOpenHelper {
    ...
    public FriendDbHelper(Context context){
        ...
        DeveloperManager.displayLog("[DbH] FriendDbHelper", "[constructor] The project_blue.db is ready to create table");
    }
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        DeveloperManager.displayLog("[DbH] FriendDbHelper", "[onCreate] The method is executing........");
        DeveloperManager.displayLog("[DbH] FriendDbHelper", "[onCreate] The project_blue.db is not exist.");
        ...
        DeveloperManager.displayLog("[DbH] FriendDbHelper", "[onCreate] The project_blue.db has been created.");
        DeveloperManager.displayLog("[DbH] FriendDbHelper", "[onCreate] billiard table has been created.");
        DeveloperManager.displayLog("[DbH] FriendDbHelper", "[onCreate] user table has been created.");
        DeveloperManager.displayLog("[DbH] FriendDbHelper", "[onCreate] friend table has been created.");
        DeveloperManager.displayLog("[DbH] FriendDbHelper", "[onCreate] All tables must be created when creating a project_blue.db. ");
        DeveloperManager.displayLog("[DbH] FriendDbHelper", "[onCreate] The method is complete.");
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        DeveloperManager.displayLog("[DbH] FriendDbHelper", "[onUpgrade] The method is executing........");
        DeveloperManager.displayLog("[DbH] FriendDbHelper", "[onUpgrade] The project_blue.db is upgrading.");
        ...
        DeveloperManager.displayLog("[DbH] FriendDbHelper", "[onUpgrade] already existed table delete.");
        onCreate(db);
        DeveloperManager.displayLog("[DbH] FriendDbHelper", "[onUpgrade] The method is complete.");
    }
    ...
    public void onDowngrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        DeveloperManager.displayLog("[DbH] FriendDbHelper", "[onDowngrade] The method is complete!");
    }
    ...
    public void onOpen(SQLiteDatabase db) {
        ...
        super.onOpen(db);
        DeveloperManager.displayLog("[DbH] FriendDbHelper", "[onOpen] The method is complete.");
    }
