								...
								<div class="card-body">
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											<p>
												access_token :
												<%=sessionManager.getToken().getAccess_token()%></p>
											<p>
												expires_in :
												<%=sessionManager.getToken().getExpires_in()%></p>
											<p>
												refresh_token :
												<%=sessionManager.getToken().getRefresh_token()%></p>
											<p>
												refresh_toekn_expires_in :<%=sessionManager.getToken().getRefresh_token_expires_in()%></p>
											<p>
												scope :
												<%=sessionManager.getToken().getScope()%></p>
											<p>
												token_type :
												<%=sessionManager.getToken().getToken_type()%></p>
										</div>
										<div class="col-auto">
											<i class="fas fa-calendar fa-2x text-gray-300"></i>
										</div>
									...
									<div class="row no-gutters align-items-center">
										<div class="col-auto">
											<div class="h6 mb-0 font-weight-bold text-gray-800">
												== id :
												<%=sessionManager.getUserInfo().getId()%></div>
											<div class="h6 mb-0 font-weight-bold text-gray-800">
												== connected_at :
												<%=sessionManager.getUserInfo().getConnected_at()%></div>
											<div class="h6 mb-0 font-weight-bold text-gray-800">==
												properties</div>
											<div class="h6 mb-0 font-weight-bold text-gray-800">
												======= nickname :
												<%=sessionManager.getUserInfo().getProperties().getNickname()%></div>
											<div class="h6 mb-0 font-weight-bold text-gray-800">
												======= profile_image :
												<%=sessionManager.getUserInfo().getProperties().getProfile_image()%></div>
											<div class="h6 mb-0 font-weight-bold text-gray-800">
												======= thumbnail_image :
												<%=sessionManager.getUserInfo().getProperties().getThumbnail_image()%></div>
											<div class="h6 mb-0 font-weight-bold text-gray-800">==
												kakao_accuount</div>
											<div class="h6 mb-0 font-weight-bold text-gray-800">
												======= profile_needs_agreement :
												<%=sessionManager.getUserInfo().getKakao_accout().getProfile_needs_agreement()%></div>
											<div class="h6 mb-0 font-weight-bold text-gray-800">=======
												profile</div>
											<div class="h6 mb-0 font-weight-bold text-gray-800">
												============ nickname :
												<%=sessionManager.getUserInfo().getKakao_accout().getProfile().getNickname()%></div>
											<div class="h6 mb-0 font-weight-bold text-gray-800">
												============ thumbnail_image_url :
												<%=sessionManager.getUserInfo().getKakao_accout().getProfile().getThumbnail_image()%></div>
											<div class="h6 mb-0 font-weight-bold text-gray-800">
												============ profile_image_url :
												<%=sessionManager.getUserInfo().getKakao_accout().getProfile().getProfile_image_url()%></div>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="card-body">
									<div class="row no-gutters align-items-center">
										<div class="col-xl-6 col mr-6  mb-4">
											<img
												src=<%=sessionManager.getUserInfo().getKakao_accout().getProfile().getProfile_image_url()%>>
											<div class="h6 mb-0 font-weight-bold text-gray-800">profile
												image</div>
										</div>
										<div class="col-xl-6 col mr-6  mb-4">
											<img
												src=<%=sessionManager.getUserInfo().getKakao_accout().getProfile().getThumbnail_image()%>>
											<div class="h6 mb-0 font-weight-bold text-gray-800">Thumbnail
												image</div>
										</div>
									</div>
								</div>
