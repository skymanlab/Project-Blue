                    ...
                    <div class="container-fluid">
                              ...
                              <div class="col-xl-12 col-lg-12">
                                   <div class="card shadow mb-4">
                                        ...
                                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                             ...
                                             ><i class="fas fa-download fa-sm text-white-50 right"></i> 더보기</a>
                                        </div>
                                                       ...
                                                       <div class="card border-left-primary shadow h-100 py-2">
                                                            <div class="card-body">
                                                                 <div class="row no-gutters align-items-center">
                                                                      <div class="col mr-2">
                                                                           <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">날짜</div>
                                                                           <div class="h5 mb-0 font-weight-bold text-gray-800">8월 30일</div>
                                                                      </div>
                                                                      <div class="col-auto">
                                                  ...
                                                  <div class="col-xl-4 col-md-12 mb-4">
                                                       <div class="card border-left-primary shadow h-100 py-2">
                                                            <div class="card-body">
                                                                 <div class="row no-gutters align-items-center">
                                                                      <div class="col mr-2">
                                                                           <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">승자</div>
                                        ...
                                        <div class="card-body">
                                             <div class="row no-gutters align-items-center">
                                                  <div class="col mr-2">
                                                       <p>
                                                            access_token :
                                                            <%=responseTokenData.getAccess_token()%></p>
                                                       <p>
                                                            expires_in :
                                                            <%=responseTokenData.getExpires_in()%></p>
                                                       <p>
                                                            refresh_token :
                                                            <%=responseTokenData.getRefresh_token()%></p>
                                                       <p>
                                                            refresh_toekn_expires_in :<%=responseTokenData.getRefresh_token_expires_in()%></p>
                                                       <p>
                                                            scope :
                                                            <%=responseTokenData.getScope()%></p>
                                                       <p>
                                                            token_type :
                                                            <%=responseTokenData.getToken_type()%></p>
                                                  </div>
                                                  <div class="col-auto">
                                                       <i class="fas fa-calendar fa-2x text-gray-300"></i>
                                                  </div>
                              ...
                              <div class="col-xl-12 col-md-6 mb-4">
                                   <div class="card border-left-primary shadow h-100 py-2">
                                        <div class="card-header">
                                             <div class="h5 mb-0 font-weight-bold text-gray-800">User Info</div>
                                        </div>
                                        <div class="card-body">
                                             <div class="row no-gutters align-items-center">
                                                  <div class="col-auto">
                                                       <div class="h6 mb-0 font-weight-bold text-gray-800">
                                                            == id :
                                                            <%=responseUserInfoData.getId()%></div>
                                                       <div class="h6 mb-0 font-weight-bold text-gray-800">
                                                            == connected_at :
                                                            <%=responseUserInfoData.getConnected_at()%></div>
                                                       <div class="h6 mb-0 font-weight-bold text-gray-800">== properties</div>
                                                       <div class="h6 mb-0 font-weight-bold text-gray-800">
                                                            ======= nickname :
                                                            <%=responseUserInfoData.getProperties().getNickname()%></div>
                                                       <div class="h6 mb-0 font-weight-bold text-gray-800">
                                                            ======= profile_image :
                                                            <%=responseUserInfoData.getProperties().getProfile_image()%></div>
                                                       <div class="h6 mb-0 font-weight-bold text-gray-800">
                                                            ======= thumbnail_image :
                                                            <%=responseUserInfoData.getProperties().getThumbnail_image()%></div>
                                                       <div class="h6 mb-0 font-weight-bold text-gray-800">== kakao_accuount</div>
                                                       <div class="h6 mb-0 font-weight-bold text-gray-800">
                                                            ======= profile_needs_agreement :
                                                            <%=responseUserInfoData.getKakao_accout().getProfile_needs_agreement()%></div>
                                                       <div class="h6 mb-0 font-weight-bold text-gray-800">======= profile</div>
                                                       <div class="h6 mb-0 font-weight-bold text-gray-800">
                                                            ============ nickname :
                                                            <%=responseUserInfoData.getKakao_accout().getProfile().getNickname()%></div>
                                                       <div class="h6 mb-0 font-weight-bold text-gray-800">
                                                            ============ thumbnail_image_url :
                                                            <%=responseUserInfoData.getKakao_accout().getProfile().getThumbnail_image()%></div>
                                                       <div class="h6 mb-0 font-weight-bold text-gray-800">
                                                            ============ profile_image_url :
                                                            <%=responseUserInfoData.getKakao_accout().getProfile().getProfile_image_url()%></div>
                                                  </div>
                                             </div>
                                        </div>
                                   </div>
                         ...
                         <div class="row">
                              ...
                              <div class="col-xl-12 col-md-6 mb-4">
                                   <div class="card border-left-primary shadow h-100 py-2">
                                        <div class="card-header">
                                             <div class="h5 mb-0 font-weight-bold text-gray-800">User Image</div>
                                        </div>
                                        <div class="card-body">
                                             <div class="row no-gutters align-items-center">
                                                  <div class="col-xl-6 col mr-6  mb-4">
                                                       <img src=<%=responseUserInfoData.getKakao_accout().getProfile().getProfile_image_url()%>>
                                                       <div class="h6 mb-0 font-weight-bold text-gray-800">profile image</div>
                                                  </div>
                                                  <div class="col-xl-6 col mr-6  mb-4">
                                                       <img src=<%=responseUserInfoData.getKakao_accout().getProfile().getThumbnail_image()%>>
                                                       <div class="h6 mb-0 font-weight-bold text-gray-800">Thumbnail image</div>
                                                  </div>
                                             </div>
                                        </div>
                                   </div>
