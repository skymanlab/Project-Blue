			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div
						...
						<h1 class="h3 mb-0 text-gray-800">Page Format</h1>
						<a href="#"
							...
							<div class="card border-left-primary shadow h-100 py-2">
								<div class="card-body">
									<div class="row no-gutters align-items-center">
										<div class="col-auto">
											<div
												class="text-xs font-weight-bold text-primary text-uppercase mb-1">총
												전적</div>
								...
								<div
									...
									<div class="dropdown no-arrow">
										<a class="dropdown-toggle" href="#" role="button"
											id="opponent_score_menu" data-toggle="dropdown"
										...
										<div
											...
											<a class="dropdown-item" href="#">김현</a>
											<a class="dropdown-item" href="#">아무개</a>
											<div class="dropdown-divider"></div>
