               ...
               <div id="content">
                    ...
                    <div class="container-fluid">
                         ...
                         <div class="d-sm-flex align-items-center justify-content-between mb-4">
                              <h1 class="h3 mb-0 text-gray-800">Billiard Main</h1>
                              <h2class
                                   ="d-none
                                   d-sm-inline-block
                                   btn
                                   ...
                                   <div class="card border-left-primary shadow h-100 py-2">
                                        <div class="card-body">
                                             <div class="row no-gutters align-items-center">
                                                  <div class="col-auto">
                                                       <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">총 전적</div>
                                                       <div
                              ...
                              <div class="col-xl-3 col-md-6 mb-4">
                                   <div class="card border-left-primary shadow h-100 py-2">
                                        <div class="card-body">
                                             <div class="row no-gutters align-items-center">
                                                  <div class="col-auto ">
                                                       <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">총 이용금액</div>
                                                       <div
                                                            class="h5 mb-0 font-weight-bold text-gray-800"
                                                            id="leatest_"
                                                       >예) 110,000원</div>
                              ...
                              <div class="col-xl-6 col-lg-7">
                                   <div class="card shadow mb-4">
                                        ...
                                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                             <h6 class="m-0 font-weight-bold text-primary">상대 전적</h6>
                                             <div class="dropdown no-arrow">
                                                  <a
                                                       class="dropdown-toggle"
                                                       href="#"
                                                       role="button"
                                                       id="opponent_score_menu"
                                                       data-toggle="dropdown"
                                                       aria-haspopup="true"
                                                       aria-expanded="false"
                                                  ...
                                                  <div
                                                       ...
                                                       aria-labelledby="opponent_score_menu"
                                                  >
                                                       <div class="dropdown-header">대전 상대:</div>
                                                       <a
                                                            class="dropdown-item"
                                                            href="#"
                                                       >김현</a> <a
